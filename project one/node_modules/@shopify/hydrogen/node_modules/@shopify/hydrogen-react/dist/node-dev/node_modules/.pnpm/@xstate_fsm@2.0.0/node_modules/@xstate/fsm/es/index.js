//#region ../../node_modules/.pnpm/@xstate+fsm@2.0.0/node_modules/@xstate/fsm/es/index.js
/*! *****************************************************************************
...
function o(t, n) {
	return "string" == typeof (t = "string" == typeof t && n && n[t] ? n[t] : t) ? { type: t } : "function" == typeof t ? {
		type: t.name,
		exec: t
	} : t;
}
	...
	return [
		t.filter((function(t) {
			if ("xstate.assign" === t.type) {
				...
				return "function" == typeof t.assignment ? n = t.assignment(r, e) : Object.keys(t.assignment).forEach((function(i) {
					n[i] = "function" == typeof t.assignment[i] ? t.assignment[i](r, e) : t.assignment[i];
				})), r = n, !1;
			}
			return !0;
		})),
	...
	var s = t(f(r(n.states[n.initial].entry).map((function(t) {
		...
		transition: function(e, i) {
			var s, l, v = "string" == typeof e ? {
				value: e,
				context: n.context
			} : e, p = v.value, g = v.context, d = u(i), x = n.states[p];
			if (x.on) {
				var m = r(x.on[d.type]);
				try {
...
function v(t) {
	var r = t.initialState, i = n.NotStarted, o = /* @__PURE__ */ new Set(), c = {
		...
		subscribe: function(t) {
			return o.add(t), t(r), { unsubscribe: function() {
				return o.delete(t);
			} };
		},
		start: function(o) {
			if (o) {
				var u = "object" == typeof o ? o : {
