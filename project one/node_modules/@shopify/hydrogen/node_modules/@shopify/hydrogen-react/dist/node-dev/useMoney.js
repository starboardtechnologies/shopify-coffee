...
function useMoney(money) {
	const { countryIsoCode, languageIsoCode } = require_ShopifyProvider.useShop();
	...
	const { defaultFormatter, nameFormatter, narrowSymbolFormatter, withoutTrailingZerosFormatter, withoutCurrencyFormatter, withoutTrailingZerosOrCurrencyFormatter } = (0, react.useMemo)(() => {
	...
	const lazyFormatters = (0, react.useMemo)(() => ({
		original: () => money,
	...
	return (0, react.useMemo)(() => new Proxy(lazyFormatters, { get: (target, key) => Reflect.get(target, key)?.call(null) }), [lazyFormatters]);
}
